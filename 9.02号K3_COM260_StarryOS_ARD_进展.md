...
一开始目标：先让 StarryOS 在 K3 COM260 上稳定运行，再把 ARD 调试器真正接到这块板子上。
...
最开始我们先解决的是：**StarryOS 在 K3 这块板子上跑起来**
...
StarryOS 能跑以后，我们就正式转： **让电脑直接控制 K3 CPU**
